...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_title)){
        ...
        $title_err = "Please enter your valid title.";
    } else{
        $title = $input_title;
    }
    ...
    if(empty($input_icon)){
        ...
        $icon_err = "Please enter your valid icon.";
    } else{
        $icon = $input_icon;
    }
    ...
    if(empty($title_err) && empty($description_err) && empty($icon_err)){
        ...
        $sql = "INSERT INTO service (title, description, icon) VALUES (?, ?, ?)";
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-header">
                    <h2>Create service data record </h2>
                </div>
